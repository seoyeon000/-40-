...
while True:
    ...
    sigma_r_vlaue = cv2.getTrackbarPos("sigma_r", "Trackbar Windows") / 100.0
    
    print("sigma_s_value: ", sigma_s_value)
    print("sigma_r_value: ", sigma_r_vlaue)
    
    cartoon_img = cv2.stylization(img, sigma_s = sigma_s_value, sigma_r = sigma_r_vlaue)
